...
<style>
    /* Copy y hệt <style> từ file forgot-password.jsp */
    body {
...
<body>
	<div class="login-container">
		<form action="reset-password" method="post">
			<h2 class="text-center" style="color: #ffffff;">Tạo mật khẩu mới</h2>
			...
			<p style="color: #c5c6c7;">Đặt lại mật khẩu cho tài khoản: <b>${sessionScope.resetEmail}</b></p>
